		...
		<div class="body">
			...
			<div>
				<span title="Click to refresh captured data log" onclick="document.location.reload(true);" style="cursor: pointer;margin-right:35px;font-weight: bold;">
					<img width="32px" height="32px" src="./resources/icon/refresh_icon.ico" style="vertical-align:middle;">
					Refresh
				</span>
				...
				<span title="Click to visit capture data page. Your data will be captured."
					...
					<img width="32px" height="32px" src="./resources/icon/capture_icon.ico" style="vertical-align:middle;">
					Capture Data
				</span>
			</div>
			<br>
			...
			<?php
				try{// to draw table
					...
					echo '<table border="1px;" width="100%" class="results-table"><tbody>';
